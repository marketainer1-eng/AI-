import { ApplicationStatus, STATUS_LABEL, STATUS_FLOW } from '@/types'
...
function getStepIndex(status: ApplicationStatus): number {
  if (status === 'failed') return STATUS_FLOW.indexOf('passed')
          ...
          return (
            <div key={step} className="flex flex-1 items-center">
              ...
              <div className="flex flex-col items-center flex-shrink-0">
                ...
                >
                  {isFailed && idx === currentIdx ? '불합격' : STATUS_LABEL[step]}
                </span>
              </div>
